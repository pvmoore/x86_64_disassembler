...
void parseTwoByteOpcode(Parser p, uint byte1, uint byte2) {
    ...
    switch(hiNibble) {
        ...
        case 0x1:
            if(loNibble==8) {
                ...
                if(modrm.mod==0b11) {
                    ...
                    if(loNibble==2) { p.instr.copy(Instruction("movhlps", ps_VoqUoq)); return; }
                    else if(loNibble==6) { p.instr.copy(Instruction("movlhps", ps_VoqUoq)); return; }
                }
        ...
        case 0x7:
            if(loNibble==1) group12(p);
                ...
                if(loNibble==0xE && p.prefix.rexW()) {
                    p.instr.copy(Instruction("movq", ps_EyVy));
                }
                ...
                /* no prefix */
                if(loNibble==0xE && p.prefix.rexW()) {
                    p.instr.copy(Instruction("movq", ps_EyPy));
                }
        ...
        case 0xB:
            if(p.prefix.rep) {
                /* F3 */
                if(loNibble==0x8) p.instr.copy(Instruction("popcnt", ps_GvEv));
        ...
        case 0xD:
            if(p.prefix.rep) {
                ...
                /* F2 */
                if(loNibble==0x0) p.instr.copy(Instruction("addsubps", ps_VpsWps));
                else if(loNibble==0x6) p.instr.copy(Instruction("movdq2q", ps_PqUq));
        ...
        case 0xF:
            if(p.prefix.repne) {
                /* F2 */
                if(loNibble==0x0) p.instr.copy(Instruction("lddqu", ps_VoMo));
            } else if(p.prefix.opSize) {
                /* 66 */
...
__gshared Instruction[] INSTRUCTIONS_row_1 = [
    Instruction("movups", ps_VpsWps),       /* lo=0 */
    Instruction("movups", ps_WpsVps),       /* lo=1 */
    Instruction("movlps", ps_VqMq),         /* lo=2 */
    Instruction("movlps", ps_MqVq),         /* lo=3 */
    Instruction("unpcklps", ps_VpsWps),     /* lo=4 */
    Instruction("unpckhps", ps_VpsWps),     /* lo=5 */
    Instruction("movhps", ps_VoqMq),        /* lo=6 */
    Instruction("movhps", ps_MqVoq),        /* lo=7 */
...
__gshared Instruction[] INSTRUCTIONS_row_1_F3 = [
    Instruction("movss", ps_VssWss),        /* lo=0 */
    Instruction("movss", ps_WssVss),        /* lo=1 */
    Instruction("movsldup", ps_VpsWps),    /* lo=2 */
    Instruction("", null),                  /* lo=3 - invalid */
    Instruction("", null),                  /* lo=4 - invalid */
    Instruction("", null),                  /* lo=5 - invalid */
    Instruction("movshdup", ps_VpsWps),    /* lo=6 */
...
__gshared Instruction[] INSTRUCTIONS_row_1_F2 = [
    ...
    Instruction("movddup", ps_VoWsd),          /* lo=2 */
    Instruction("", null),                      /* lo=3 - invalid */
    Instruction("", null),                      /* lo=4 - invalid */
    Instruction("", null),                      /* lo=5 - invalid */
...
__gshared Instruction[] INSTRUCTIONS_row_2 = [
    ...
    Instruction("", null),                  /* lo=6 - invalid */
    Instruction("", null),                  /* lo=7 - invalid */
    Instruction("movaps", ps_VpsWps),       /* lo=8 */
    Instruction("movaps", ps_WpsVps),       /* lo=9 */
    Instruction("cvtpi2ps", ps_VpsQpj),     /* lo=A */
    Instruction("movntps", ps_MoVps),       /* lo=B */
    Instruction("cvttps2pi", ps_PpjWps),    /* lo=C */
    Instruction("cvtps2pi", ps_PpjWps),     /* lo=D */
    Instruction("ucomiss", ps_VssWss),      /* lo=E */
    Instruction("comiss", ps_VssWss),       /* lo=F */
];
...
__gshared Instruction[] INSTRUCTIONS_row_2_F3 = [
    ...
    Instruction("", null),                  /* lo=8 - invalid */
    Instruction("", null),                  /* lo=9 - invalid */
    Instruction("cvtsi2ss", ps_VssEy),      /* lo=A */
    Instruction("movntss", ps_MdVss),       /* lo=B */
    Instruction("cvttss2si", ps_GyWss),     /* lo=C */
    Instruction("cvtss2si", ps_GyWss),      /* lo=D */
    Instruction("", null),                  /* lo=E - invalid **/
    Instruction("", null),                  /* lo=F - invalid **/
];
/* row 3 */
...
__gshared Instruction[] INSTRUCTIONS_row_5 = [
    Instruction("movmskps", ps_GdUps),      /* lo=0 */
    Instruction("sqrtps", ps_VpsWps),       /* lo=1 */
    Instruction("rsqrtps", ps_VpsWps),      /* lo=2 */
    Instruction("rcpps", ps_VpsWps),        /* lo=3 */
    Instruction("andps", ps_VpsWps),        /* lo=4 */
    Instruction("andnps", ps_VpsWps),       /* lo=5 */
    Instruction("orps", ps_VpsWps),         /* lo=6 */
    Instruction("xorps", ps_VpsWps),        /* lo=7 */
    Instruction("addps", ps_VpsWps),        /* lo=8 */
    Instruction("mulps", ps_VpsWps),        /* lo=9 */
    Instruction("cvtps2pd", ps_VpsWps),    /* lo=A */
    Instruction("cvtdq2ps", ps_VpsWps),    /* lo=B */
    Instruction("subps", ps_VpsWps),        /* lo=C */
    Instruction("minps", ps_VpsWps),        /* lo=D */
    Instruction("divps", ps_VpsWps),        /* lo=E */
...
__gshared Instruction[] INSTRUCTIONS_row_5_F3 = [
    Instruction("", null),                  /* lo=0 - invalid */
    Instruction("sqrtss", ps_VssWss),       /* lo=1 */
    Instruction("rsqrtss", ps_VssWss),      /* lo=2 */
    Instruction("rcpss", ps_VssWss),        /* lo=3 */
    Instruction("", null),                  /* lo=4 - invalid */
    Instruction("", null),                  /* lo=5 - invalid */
    Instruction("", null),                  /* lo=6 - invalid */
    Instruction("", null),                  /* lo=7 - invalid */
    Instruction("addss", ps_VssWss),        /* lo=8 */
    Instruction("mulss", ps_VssWss),        /* lo=9 */
    Instruction("cvtss2sd", ps_VssWss),    /* lo=A */
    Instruction("cvttps2dq", ps_VoWps),    /* lo=B */
    Instruction("subss", ps_VssWss),        /* lo=C */
    Instruction("minss", ps_VssWss),        /* lo=D */
    Instruction("divss", ps_VssWss),        /* lo=E */
    Instruction("maxss", ps_VssWss),        /* lo=F */
];
/* row 6 */
...
__gshared Instruction[] INSTRUCTIONS_row_7 = [
    Instruction("pshufw", ps_PqQqIb),       /* lo=0 */
...
__gshared Instruction[] INSTRUCTIONS_row_7_66 = [
    ...
    Instruction("", null),                  /* lo=A - invalid */
    Instruction("", null),                  /* lo=B - invalid */
    Instruction("haddpd", ps_VpdWpd),      /* lo=C */
    Instruction("hsubpd", ps_VpdWpd),      /* lo=D */
...
__gshared Instruction[] INSTRUCTIONS_row_7_F2 = [
    ...
    Instruction("", null),                      /* lo=A - invalid */
    Instruction("", null),                      /* lo=B - invalid */
    Instruction("haddps", ps_VpdWpd),          /* lo=C */
    Instruction("hsubps", ps_VpdWpd),          /* lo=D */
    Instruction("", null),                      /* lo=E */
    Instruction("", null),                      /* lo=F */
];
...
__gshared Instruction[] INSTRUCTIONS_row_A = [
    Instruction("push FS",  ps_none, [Hint.SIZE_64]),   /* lo=0 */
    Instruction("pop FS", ps_none, [Hint.SIZE_64]),     /* lo=1 */
    ...
    Instruction("", null),                              /* lo=6 - invalid */
    Instruction("", null),                              /* lo=7 - invalid */
    Instruction("push GS", ps_none, [Hint.SIZE_64]),    /* lo=8 */
    Instruction("pop GS", ps_none, [Hint.SIZE_64]),      /* lo=9 */
...
__gshared Instruction[] INSTRUCTIONS_row_C = [
    ...
    Instruction("cmpps", ps_VpsWpsIb),      /* lo=2 */
    Instruction("movnti", ps_MyGy),        /* lo=3 */
    Instruction("pinsrw", ps_PqEwIb),       /* lo=4 */
    Instruction("pextrw", ps_GdNqIb),       /* lo=5 */
    Instruction("shufps", ps_VpsWpsIb),     /* lo=6 */
...
__gshared Instruction[] INSTRUCTIONS_row_F = [
    ...
    Instruction("psadbw", ps_PqQq),         /* lo=6 */
    Instruction("maskmovq", ps_PqNq),       /* lo=7 */
...
__gshared Instruction[] INSTRUCTIONS_row_F_66 = [
    ...
    Instruction("psadbw", ps_VpkWpk),           /* lo=6 */
