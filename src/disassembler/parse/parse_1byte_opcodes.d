...
__gshared Instruction[] INSTRUCTIONS = [
    ...
    Instruction("push", ps_rAX, [Hint.SIZE_64]),  /* 50 */
    Instruction("push", ps_rCX, [Hint.SIZE_64]),  /* 51 */
    Instruction("push", ps_rDX, [Hint.SIZE_64]),  /* 52 */
    Instruction("push", ps_rBX, [Hint.SIZE_64]),  /* 53 */
    Instruction("push", ps_rSP, [Hint.SIZE_64]),  /* 54 */
    Instruction("push", ps_rBP, [Hint.SIZE_64]),  /* 55 */
    Instruction("push", ps_rSI, [Hint.SIZE_64]),  /* 56 */
    Instruction("push", ps_rDI, [Hint.SIZE_64]),  /* 57 */
    Instruction("pop", ps_rAX, [Hint.SIZE_64]),   /* 58 */
    Instruction("pop", ps_rCX, [Hint.SIZE_64]),   /* 59 */
    Instruction("pop", ps_rDX, [Hint.SIZE_64]),   /* 5A */
    Instruction("pop", ps_rBX, [Hint.SIZE_64]),   /* 5B */
    Instruction("pop", ps_rSP, [Hint.SIZE_64]),   /* 5C */
    Instruction("pop", ps_rBP, [Hint.SIZE_64]),   /* 5D */
    Instruction("pop", ps_rSI, [Hint.SIZE_64]),   /* 5E */
    Instruction("pop", ps_rDI, [Hint.SIZE_64]),   /* 5F */
    ...
    Instruction("push", ps_Iz, [Hint.SIZE_64]), /* 68 */
    ...
    Instruction("pushf", ps_Fv, [Hint.SIZE_64]),/* 9C */
    Instruction("popf", ps_Fv, [Hint.SIZE_64]), /* 9D */
    ...
    Instruction("movs", ps_b, [Hint.SIZE_8]),   /* A4 */
    Instruction("movs", ps_v),                  /* A5 */
    Instruction("cmps", ps_b, [Hint.SIZE_8]),   /* A6 */
    Instruction("cmps", ps_v),                  /* A7 */
    Instruction("test", ps_ALIb),               /* A8 */
    Instruction("test", ps_rAXIz),              /* A9 */
    Instruction("stob", ps_b, [Hint.SIZE_8]),   /* AA */
    Instruction("stos", ps_v),                  /* AB */
    Instruction("lods", ps_b, [Hint.SIZE_8]),   /* AC */
    Instruction("lods", ps_v),                  /* AD */
    Instruction("scas", ps_b, [Hint.SIZE_8]),   /* AE */
